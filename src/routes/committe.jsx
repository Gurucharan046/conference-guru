    ...
    <section className='committe-page-main-container'>
        ...
        <div className="patrons-container">
            ...
            <div className="committe-container">
                <h3 className="committe-details">Dr. R Kumarawamy, Professor and Head, Dept. of ECE, SIT, Tumkur</h3>
        ...
        <div className="patrons-container">
            ...
            <div className="committe-container">
                ...
                <h3 className="committe-details">Mathew Magimai Doss, Idiap Research Institute, Switzerland</h3>
                ...
                <h3 className="committe-details">Dr. Rajesh Hegde, IIT Kanpur</h3>
                ...
                <h3 className="committe-details">Lokesh Rayasandra Boregowda, Samsung, Bangalore</h3>
        ...
        <div className="patrons-container">
            ...
            <div className="committe-container">
                <h3 className="committe-details">Raghavendra Prasad, IEEE Execom Member</h3>
                ...
                <h3 className="committe-details">Dayanand Kumar N C, Samsung</h3>
                ...
                <h3 className="committe-details">Ravi Hosamani, KLETU Hubli</h3>
                ...
                <h3 className="committe-details">Chandrashekar Patil, Cisco Pvt. Ltd., Bangalore</h3>
                ...
                <h3 className="committe-details">Y Pandu Rangaiah, Vardhaman College of Engineering, Hyderabad</h3>
